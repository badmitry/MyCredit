...
import com.badmitry.vtbhackaton.di.modules.fragmentmodules.CreditFragmentModule
...
import com.badmitry.vtbhackaton.fragments.FragmentCreditFields
...
interface ComponentsModule {
    ...
    fun fragmentCredit(): FragmentCreditFields
}
